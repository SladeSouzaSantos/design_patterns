...
public class Client {
	...
	public static void main(String[] args) {
		FileSystemItem file1 = new folders.model.File("File1.txt");
		FileSystemItem file2 = new folders.model.File("File2.txt");
		FileSystemItem file3 = new folders.model.File("File3.txt");
		FileSystemItem file4 = new folders.model.File("File4.txt");
